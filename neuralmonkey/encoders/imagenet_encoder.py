    ...
    def __init__(self,
        ...
        Args:
            ...
            load_checkpoint: Checkpoint file from which the pre-trained network
                is loaded.
            save_checkpoint: Must be None, it does not make sense to change a
                model that is not trained.
        """
        check_argument_types()

        if save_checkpoint is not None:
            raise ValueError(
                "save_checkpoint must be None, it does not make sense to save "
                "a checkpoint of something that does not train.")
